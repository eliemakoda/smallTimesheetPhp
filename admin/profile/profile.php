...
$apps = new App;
$id = $_GET['id'];
$user = $apps->SelectionnerUn("SELECT * FROM utilisateur WHERE idUSer=$id");
$projetUSer=$apps->SelectionnerTout("SELECT * FROM projet WHERE idUser=$id");
$commentaire=$apps->SelectionnerTout("SELECT * from commentaires left join projet on commentaires.idProjet= projet.idProjet left join utilisateur on commentaires.idUSer= utilisateur.idUSer WHERE 1");
                            ...
                            <div class="col-sm">
                                <div class="d-flex align-items-end mt-3 mt-sm-0">
                                    ...
                                    <div class="flex-grow-1">
                                        <div>
                                            <h5 class="font-size-16 mb-1"><?php echo $user->nomUSer;?></h5>
                                            <p class="text-muted font-size-13 mb-2 pb-2">Date de Naissance: <b><?php echo $user->DateNaissUSer;?></b></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card bg-transparent shadow-none">
                            <div class="card-body">
                                <ul class="nav nav-tabs-custom card-header-tabs border-top mt-2" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link px-3" data-bs-toggle="tab" href="#post" role="tab">FeedBack Projets</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                    ...
                                    <div class="card-body">
                                        <div>
                                            <div class="pb-3">
                                               ...
                                               <?php
                                               echo htmlspecialchars_decode($user->BioUSer);
                                               ?>
                                                </div>
                                            </div>
                                            ...
                                            <div class="pt-3">
                                                ...
                                                <div class="text-muted">
                                                    ...
                                                    <ul class="list-unstyled mb-0">
                                                        <?php
                                                        $data=  explode("#",$user->CompetenceUSer);
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="blog-post">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-1">
                                                    <h5 class="font-size-15 text-truncate"><a href="" class="text-dark"><?php echo $cmt->nomUSer;?></a></h5>
