...
if (isset($_POST['enregistrer'])) {
    ...
    $sql = "INSERT INTO administrateur(nomAdmin,emailAdmin, DateNaissAdmin, BioAdmin, ExperienceAdmin, CompetenceAdmin, passwordAdmin,  ImageAdmin) VALUES(:nomAdmin,:emailAdmin, :DateNaissAdmin, :BioAdmin, :ExperienceAdmin, :CompetenceAdmin, :passwordAdmin,  :ImageAdmin)";
    ...
    if (!empty($_FILES["images"]["name"][0])) {
        ...
        $tab = [
            ":nomAdmin" => $nom,
            ":emailAdmin" => $email,
            ":DateNaissAdmin" => $datenaiss,
            ":BioAdmin" => $bio,
            ":ExperienceAdmin" => $experience,
            ":CompetenceAdmin" => $competences,
            ":passwordAdmin" => $password,
            ":ImageAdmin" => implode(",", $urlsImages)
        ];
                        ...
                        <div class="w-100">
                            <div class="d-flex flex-column h-100 w-100">
                                <div class="mb-4 mb-md-5 text-center">
                                    <a href="./AjoutAdmin.php" class="d-block auth-logo">
                                        <img src="../../assets/images/logo-sm.svg" alt="" height="28"> <span class="logo-txt">MyTimeSheet</span>
                                    </a>
                                </div>
                                <div class="auth-content my-auto">
                                    <div class="text-center">
                                        <h5 class="mb-0">Ajouter un admin</h5>
                                        <p class="text-muted mt-2">Creez votre compte Maintenant.</p>
                                    </div>

                                    <form class="needs-validation mt-4 pt-2" action="./AjoutAdmin.php" method="POST" enctype="multipart/form-data">
