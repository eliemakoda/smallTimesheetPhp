...
if(isset($_GET['id_sup'])){
    $id=$_GET['id_sup'];
    $sql="UPDATE administrateur SET statutAdmin=0 WHERE idAdmin=$id";
    $apps->maj2($sql);
}
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">Grille administrateur</h4>
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="mb-3">
                    <h5 class="card-title">Liste administrateur  <span class="text-muted fw-normal ms-2">(<?php echo $i;?>)</span></h5>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="dropdown float-end">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                <a class="dropdown-item" href="../profile/profileAdmin.php?id=<?php echo $user->idAdmin;?>">profile</a>
                                <a class="dropdown-item" href="./listGrid.php?id_sup=<?php echo $user->idAdmin;?>">Supprimer</a>
                            </div>
                        </div>
                        <div class="d-flex align-items-center">
                            ...
                            <div class="flex-1 ms-3">
                                <h5 class="font-size-15 mb-1"><a href="../profile/profileAdmin.php?id=<?php echo $user->idAdmin;?>" class="text-dark"><?php echo $user->nomAdmin;?></a></h5>
                        ...
                        <div class="mt-3 pt-1">
                            ...
                            <?php
                                echo $user->DateNaissAdmin;
                                ?></p>
                        </div>
                    </div>

                    <div class="btn-group" role="group">
                        <a type="button" class="btn btn-outline-light text-truncate" href="../profile/profileAdmin.php?id=<?php echo $user->idAdmin;?>"><i class="uil uil-user me-1"></i> Profil</a>
                    </div>
                </div>
                <!-- end card -->
            </div>
