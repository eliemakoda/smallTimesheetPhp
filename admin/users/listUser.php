                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <h5 class="card-title"> Liste utilisateur <span class="text-muted fw-normal ms-2">(<?php echo $i; ?>)</span></h5>
                                    </div>
                                </div>
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-end gap-2 mb-3">
                                        <div>
                                            <ul class="nav nav-pills">
                                                <li class="nav-item">
                                                    <a class="nav-link active" href="./listUser.php" data-bs-toggle="tooltip" data-bs-placement="top" title="List"><i class="bx bx-list-ul"></i></a>
                                                </li>
                                                <li class="nav-item">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="../profile/profile.php?id=<?php echo $user->idUSer; ?>" class="text-body"><?php echo $user->nomUSer; ?></a>
                                                    </td>
                                                    <td> <?php
                                                            echo $user->emailUSer;
                                                            ?></td>
                                                    ...
                                                    <td>
                                                        <div class="dropdown">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-end">
                                                                <li><a class="dropdown-item" href="../profile/profile.php?id=<?php echo $user->idUSer;?>">Profile</a></li>
                                                                <li><a class="dropdown-item" href="./listGrid.php?id_sup=<?php echo $user->idUSer;?>">Supprimer</a></li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                </tr>
